...
export function ReactionButton({
  ...
  const renderDefaultIcon = () => (
    <LikeSvg
      ...
      style={{ pointerEvents: 'none' }} // Inline for icon
    />
  );
  ...
  const handleClick = useCallback(
    ...
    [handleMouseLeave, handleTouchEnd, onReactionClick],
  );
